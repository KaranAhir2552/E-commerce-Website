...
function PaginationFilter({ page, handlePage, totalItems }) {
  return (
      ...
      <div className="hidden sm:flex sm:flex-1 sm:items-center sm:justify-between">
        ...
        <div>
          ...
          >
            ...
            <div
              onClick={() => {
                if (page + 1 <= Math.ceil(totalItems / ITEMS_PER_PAGE)) {
                  handlePage(page + 1);
                }
              }}
        ...
        <div className="mt-6 grid grid-cols-1 gap-x-6 gap-y-10 sm:grid-cols-2 lg:grid-cols-3 xl:gap-x-8">
          {products.map((product) => (
            <Link to="/product-detail" key={product.id}>
              <div className="group relative border border-gray-300 p-2">
                ...
                <div className="mt-4 flex justify-between">
                  <div>
                    ...
                    <div className="flex items-center">
                      <StarIcon className="w-4 h-4 inline text-gray-900" />
                  ...
                  <div>
                    ...
                    <p className="text-m font-bold line-through text-gray-500">
                      ${" "}
                      {Math.round(
