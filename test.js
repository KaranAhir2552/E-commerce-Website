const products = [
  ...
  },
  {
    id: 34,
    title: "Plastic Table",
    description: "Vufeffery good quality plastic table for multi purpose now in reasonable price",
    price: 50,
...
const arr2 = arr.map(c=>({value:c,label:c.split('-').join(' '), checked: false}))
console.log(arr2);
